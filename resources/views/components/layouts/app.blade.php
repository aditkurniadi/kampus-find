<x-layouts.app.sidebar :title="$title ?? null">
    <flux:main>
        <!-- PERUBAHAN: Toast Notification Component -->
        <div x-data="{
            show: false,
            type: 'success',
            message: '',
        ...
        message = event.detail.message || 'Default Message';
        show = true;
    ...
    "
            ...
            class="fixed right-5 top-5 z-50 w-full max-w-xs rounded-lg bg-white p-4 text-gray-500 shadow-sm dark:bg-gray-800 dark:text-gray-400"
            role="alert">
        ...
        <!-- AKHIR DARI Toast Notification Component -->
        {{ $slot }}
    </flux:main>
