<div> <!-- Root Div -->
    ...
    @if ($showModal)
        <div
            ...
            <div class="relative my-6 w-full max-w-md md:max-w-3xl p-4 max-h-[90vh]">
                ...
                <div class="relative rounded-lg bg-white shadow-sm dark:bg-gray-700">
                    ...
                    <div class="overflow-y-auto p-4 md:p-5">
                        ...
                        <form wire:submit.prevent='createReport' class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-xs leading-5 text-gray-600 dark:text-zinc-50">PNG, JPG up to
                                                5MB
                                            </p>
                                        </div>
                                    </div>
