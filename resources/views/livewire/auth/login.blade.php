    ...
    <div class="flex min-h-full">
        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                @if (session('status'))
                    <div class="mt-8 text-sm font-medium text-green-500 text-center">
                        {{ session('status') }}
                    </div>
                @endif
                        ...
                        <form action="{{ route('login.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex gap-3">
                                    ...
                                    <label for="remember"
                                        class="block text-sm/6 text-gray-300">{{ __('Remember me') }}</label>
                                </div>

                                <div class="text-sm/6">
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" wire:navigate
                                            class="font-semibold text-indigo-400 hover:text-indigo-300">{{ __('Forgot your password?') }}</a>
                                    @endif
                                </div>
                            </div>
